<?php
  ...
  $amountCad = number_format($amountUsd / CONVERSION_RATE, 2);
  $dailyBudget = number_format($amountCad / $days, 2);
  //Displaying results in web page
  echo "The total amount of money you will have for your trip in CAD is $$amountCad. The amount of money budgeted for each day of the trip is $$dailyBudget.";
?>